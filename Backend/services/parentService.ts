  ...
  static async getChildDashboard(childId: number, phone: string) {
    ...
    return {
      child: {
        ...
        school: child.school ? (() => {
          const s = child.school as any;
          return {
            schoolName: s.schoolName,
            schoolType: s.schoolType || null,
            boardAffiliation: s.boardAffiliation || null,
            udiseCode: s.udiseCode || null,
            ...
            studentStrength: s.studentStrength || null,
            schoolEmail: s.schoolEmail || null,
            pocMobile: s.pocMobile || null,
            principalName: s.principalName || null,
            principalContact: s.principalContact || null,
            principalImage: s.principalImage || null,
            vicePrincipalName: s.vicePrincipalName || null,
            vicePrincipalContact: s.vicePrincipalContact || null,
            vicePrincipalImage: s.vicePrincipalImage || null,
            fireDeptName: s.fireDeptName || null,
            fireDeptContact: s.fireDeptContact || null,
            fireDeptImage: s.fireDeptImage || null,
            policeName: s.policeName || null,
            policeContact: s.policeContact || null,
            policeImage: s.policeImage || null,
            ndrfName: s.ndrfName || null,
            ndrfContact: s.ndrfContact || null,
            ndrfImage: s.ndrfImage || null,
            nurseName: s.nurseName || null,
            nurseContact: s.nurseContact || null,
            nurseImage: s.nurseImage || null,
            gynecologistName: s.gynecologistName || null,
            gynecologistContact: s.gynecologistContact || null,
            gynecologistImage: s.gynecologistImage || null,
            pediatricianName: s.pediatricianName || null,
            pediatricianContact: s.pediatricianContact || null,
            pediatricianImage: s.pediatricianImage || null,
          };
        })() : null
      },
