    ...
    return {
      child: {
        ...
        school: child.school ? {
          ...
          schoolType: (child.school as any).schoolType || null,
          boardAffiliation: (child.school as any).boardAffiliation || null,
          udiseCode: (child.school as any).udiseCode || null,
          address: child.school.address,
          city: child.school.city,
          state: (child.school as any).state || null,
          pincode: (child.school as any).pincode || null,
          principalName: (child.school as any).principalName || null,
          principalContact: (child.school as any).principalContact || null,
          schoolEmail: (child.school as any).schoolEmail || null,
          pocMobile: (child.school as any).pocMobile || null,
          registrationNo: (child.school as any).registrationNo || null,
          nurseName: (child.school as any).nurseName || null,
          nurseContact: (child.school as any).nurseContact || null,
          studentStrength: (child.school as any).studentStrength || null,
        } : null
      },
